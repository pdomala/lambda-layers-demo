...
This is a sample template for layers-app - Below is a brief explanation of what we have generated for you:

```bash
.
├── README.md                   <-- This instructions file
├── deserialize-demo            <-- Source code for a Deserialize Demo lambda function
│   ├── main.py                 <-- Lambda function code
├── objectpath-data-demo        <-- Source code for a ObjectPath Data Demo lambda function
│   ├── main.py                 <-- Lambda function code
├── lambda-layers               <-- Source code for a ObjectPath Data Demo lambda function
│   ├── data                    <-- Data folder with aws-regions.json
│   ├── python                  <-- Python folder with custon functions and modules
│   ├── my-lambda-layer.zip     <-- Lambda layer zip file
...
aws cloudformation describe-stacks \
    --stack-name layers-app --query 'Stacks[].Outputs'
```
